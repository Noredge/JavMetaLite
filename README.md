...
`v0.9.0-dev2` 为主窗口、保存预览和内置浏览器建立共用深色主题，统一按钮、输入框、复选框、下拉框和提示框的尺寸与交互状态，并整理最小窗口和长文本布局。功能位置和操作顺序保持不变；完整人工检查见 [`MANUAL-CHECK-v0.9.0-dev2.md`](MANUAL-CHECK-v0.9.0-dev2.md)。
