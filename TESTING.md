...
| UI smoke | `JavMetaLite.UiSmokeTests` | WPF window construction, dark source selector, v0.5 mixed-source badges, field and unified artwork candidate menus, per-field switching/manual return, safe defaults and preview window |
